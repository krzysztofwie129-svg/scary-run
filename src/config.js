...
export const LEVELS = [
  ...
  // L2 — sesja 9: łagodniejsza krzywa (+30 speed, więcej low/mid)
  {
    ...
    bgFolder: 'level2',
    bgLayerCount: 7,
    parallaxSpeeds: [0.58, 0.66, 0.74, 0.81, 0.88, 0.94, 1.0],
    obstacleMix: { low: 0.65, mid: 0.25, high: 0.07, wall: 0.03 },
    obstacleSpawnRate: { min: 1.6, max: 2.4 },
  ...
  // L3
  {
    ...
    bgFolder: 'level3',
    bgLayerCount: 6,
    parallaxSpeeds: [0.60, 0.70, 0.80, 0.87, 0.94, 1.0],
    obstacleMix: { low: 0.55, mid: 0.30, high: 0.10, wall: 0.05 },
    obstacleSpawnRate: { min: 1.4, max: 2.2 },
  ...
  // L4
  {
    ...
    obstacleSpawnRate: { min: 1.3, max: 2.0 },
  ...
  // L5 — biom L2 reuse
  {
    ...
    obstacleSpawnRate: { min: 1.2, max: 1.8 },
  ...
  // L6 — biom L3 reuse
  {
    ...
    obstacleSpawnRate: { min: 1.1, max: 1.7 },
  ...
  // L7 — biom L4 reuse
  {
    ...
    obstacleSpawnRate: { min: 1.0, max: 1.6 },
  ...
  // L8 — Dragon Dungeon 1 (NEW, sesja 9)
  {
    ...
    bgFolder: 'level8',
    bgLayerCount: 5,
    parallaxSpeeds: [0.62, 0.74, 0.84, 0.92, 1.0],
  ...
  // L9 — Dragon Dungeon 2 (NEW)
  {
    ...
    obstacleSpawnRate: { min: 0.85, max: 1.4 },
    coinSpawnRate: { min: 0.4, max: 0.85 },
    diamondChance: 0.30,
    worldSpeed: 600,
    musicVolume: 0.0,
  ...
  // L11 — Dragon Dungeon 4 (NEW — FINAL)
  {
    ...
    obstacleSpawnRate: { min: 0.75, max: 1.25 },
    coinSpawnRate: { min: 0.4, max: 0.85 },
    diamondChance: 0.30,
    worldSpeed: 700,
    musicVolume: 0.0,
